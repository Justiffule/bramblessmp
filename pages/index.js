...
const Home = ({ banner, brands, features, intro, speciality, special_mention }) => {
  const paginationRef = useRef(null);
  const special_mentionPaginationRef = useRef(null);
  ...
  return (
    <Base>
      ...
      {/* special_mention */}
      <section className="section pt-0 hidden">
        <div className="container">
          <div className="animate text-center">
            <p>{special_mention.subtitle}</p>
            {markdownify(special_mention.title, "h2", "mt-4 section-title")}
            {markdownify(special_mention.description, "p", "mt-10")}
          </div>
                ...
                <div className="md:col-7 lg:col-6 xl:col-4">
                  {
                    <Swiper
                      ...
                      pagination={{
                        el: special_mentionPaginationRef.current,
                        type: "bullets",
                        dynamicBullets: true,
                        clickable: true,
                      }}
                      ...
                      onBeforeInit={(swiper) => {
                        swiper.params.pagination.el =
                          special_mentionPaginationRef.current;
                      }}
                      className="special_mention-slider mx-auto max-w-[420px] cursor-pointer lg:max-w-[480px]"
                    >
                      {special_mention.list.map((item, index) => (
                        <SwiperSlide
                          className="text-center"
                          key={"special_mention-" + index}
                        >
                  ...
                  <div className="relative h-8">
                    <div
                      ...
                      ref={special_mentionPaginationRef}
                    ></div>
                  </div>
                </div>
                <div className="hidden lg:col-3 xl:col-4 lg:block">
...
export const getStaticProps = async () => {
  ...
  const { banner, brands, features, intro, speciality, special_mention } =
    frontmatter;
