...
features:
  ...
  list:
    - icon: 'lock' # feather icon: https://feathericons.com/
      title: Territories
      content: In Brambles SMP there are 3 server owner territories. There is The Canis Alliance, Asland and The Legion of Kayoss which is run by Taz/Kayoss. Players can pay in game currency to create their own territory as well!
    - icon: 'dollar-sign'
      title: New Currantcy
